...
public class RFIDJFrame_Firebase extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RFIDJFrame_Firebase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RFIDJFrame_Firebase().setVisible(true);
            }
        });
    }
